...
class StartRepairOrderExecutionUseCaseTest {
    ...
    @InjectMocks
    private StartRepairOrderExecutionUseCase useCase;
    ...
    @Test
    void shouldThrowWhenRepairOrderIsNotApproved() {
        ...
        assertEquals(
                "Invalid Repair Order State: Repair Order must be APPROVED to start execution.",
                exception.getMessage()
        );
    ...
    @Test
    void shouldThrowWhenRepairOrderIsInDiagnosis() {
    ...
    @Test
    void shouldThrowWhenRepairOrderIsAlreadyInExecution() {
    ...
    @Test
    void shouldNotPersistWhenStartExecutionFails() {
    ...
    @Test
    void shouldPersistTheSameRepairOrderAfterStartingExecution() {
