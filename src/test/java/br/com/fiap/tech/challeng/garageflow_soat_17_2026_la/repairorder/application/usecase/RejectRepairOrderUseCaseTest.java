...
class RejectRepairOrderUseCaseTest {
    ...
    @InjectMocks
    private RejectRepairOrderUseCase useCase;
    ...
    @Test
    void shouldThrowWhenRepairOrderIsAlreadyRejected() {
    ...
    @Test
    void shouldNotPersistRepairOrderWhenRejectionFails() {
    ...
    @Test
    void shouldPersistTheSameRepairOrderAfterRejection() {
