...
class StartRepairOrderDiagnosisUseCaseTest {
    ...
    @InjectMocks
    private StartRepairOrderDiagnosisUseCase useCase;
    ...
    void shouldStartDiagnosisSuccessfully() {
        ...
        assertEquals(
                RepairOrderStatus.IN_DIAGNOSIS,
                result.getStatus()
        );
    ...
    @Test
    void shouldThrowWhenRepairOrderIsNotReceived() {
        ...
        assertEquals(
                "Invalid Repair Order State: Repair Order must be RECEIVED to start diagnosis.",
                exception.getMessage()
        );
    ...
    @Test
    void shouldThrowWhenRepairOrderIsAlreadyInDiagnosis() {
    ...
    @Test
    void shouldThrowWhenRepairOrderIsAwaitingApproval() {
    ...
    @Test
    void shouldThrowWhenRepairOrderIsApproved() {
    ...
    @Test
    void shouldNotPersistWhenStartDiagnosisFails() {
    ...
    @Test
    void shouldPersistTheSameRepairOrderAfterStartingDiagnosis() {
