...
@Service
public class ApprovePurchaseListUseCase {

    private final PurchaseListRepository purchaseListRepository;

    public ApprovePurchaseListUseCase(PurchaseListRepository purchaseListRepository) {
        this.purchaseListRepository = purchaseListRepository;
    }

    public PurchaseList execute(String id, String approvedBy) {
        PurchaseList purchaseList = purchaseListRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("PurchaseList", "id", id));

        purchaseList.approve(approvedBy);
